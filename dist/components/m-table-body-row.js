  ...
  (0, _createClass2["default"])(MTableBodyRow, [{
    ...
    value: function renderDetailPanelColumn() {
      ...
      if (typeof this.props.detailPanel == 'function') {
        return /*#__PURE__*/React.createElement(_TableCell["default"], {
          ...
          }, this.rotateIconStyle(!this.props.icons.DetailPanelOpen && this.props.data.tableData.showDetailPanel)),
          onClick: function onClick(event) {
            _this4.props.onToggleDetailPanel(_this4.props.path, _this4.props.detailPanel);

            event.stopPropagation();
          }
        }, this.props.icons.DetailPanelOpen && this.props.data.tableData.showDetailPanel ? this.props.icons.DetailPanelOpen : /*#__PURE__*/React.createElement(this.props.icons.DetailPanel, null)));
      } else {
        return /*#__PURE__*/React.createElement(_TableCell["default"], {
          size: size,
          padding: "none",
          ...
          if (isOpen) {
            if (panel.openIcon) {
              ...
              animation = false;
            } else if (_this4.props.icons.DetailPanelOpen) {
              iconButton = /*#__PURE__*/React.createElement(_this4.props.icons.DetailPanelOpen, null);
              animation = false;
            } else if (panel.icon) {
              iconButton = /*#__PURE__*/React.createElement(CustomIcon, {
                icon: panel.icon,
    ...
    value: function renderTreeDataColumn() {
      ...
      if (this.props.data.tableData.childRows && this.props.data.tableData.childRows.length > 0) {
        ...
        }, this.props.icons.DetailPanelOpen && this.props.data.tableData.isTreeExpanded ? /*#__PURE__*/React.createElement(this.props.icons.DetailPanelOpen, null) : /*#__PURE__*/React.createElement(this.props.icons.DetailPanel, null)));
      } else {
        return /*#__PURE__*/React.createElement(_TableCell["default"], {
          padding: "none",
          key: "key-tree-data-column"
